...
Also, I put graph of only prediction to see them clearly.
```{r}
plot(ARmodel_hourly_forecast_new)
```
...
You can reach my script file form here: https://github.com/BU-IE-360/spring20-BahadirAyan/blob/master/files/IE360Homework2%263.R